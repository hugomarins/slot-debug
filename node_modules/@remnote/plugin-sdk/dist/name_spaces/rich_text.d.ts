import { PluginRem, RemId, RichTextFormatName, RichTextInterface } from '../interfaces';
...
export declare class RichTextBuilder {
     ...
     */
    rem: (rem: RemId | PluginRem) => RichTextBuilder;
    /**
     * Append image rich text to the rich text builder.
     */
...
export declare class RichTextNamespace extends NamespaceBase {
     ...
     */
    get rem(): (rem: string | PluginRem) => RichTextBuilder;
    /**
    ...
    /**
     * Parse and insert a tree of Rem from html
     * @param html  The html to parse
     * @param rem   The Rem or RemId to insert the parsed html into
     */
    parseAndInsertHtml: (html: string, rem: PluginRem | RemId) => Promise<void>;
}
