import { CardData, PluginCardType, QueueInteractionScore, RemId, RepetitionStatusInterface } from '../interfaces';
...
export declare class Card extends NamespaceBase {
     ...
     * Clozes are represented by a cloze id string.
     */
    getType: () => Promise<PluginCardType>;
    /**
     * Get the Rem this Card was generated from.
     */
    getRem: () => Promise<RemObject | undefined>;
    /**
     * Remove this Card.
     */
    remove: () => Promise<void>;
