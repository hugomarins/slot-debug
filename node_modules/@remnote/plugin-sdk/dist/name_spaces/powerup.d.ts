...
interface GetPowerupSlotByCodeOverload {
     ...
     */
    <PowerupCode extends BuiltInPowerupCodes>(powerupCode: PowerupCode, powerupSlot: SlotCodesForPowerup<PowerupCode>): Promise<RemObject | undefined>;
    /**
     * Get the the Rem representing a plugin's powerup slot.
     */
    (powerupCode: string, powerupSlot: string): Promise<RemObject | undefined>;
}
/**
 * # Powerup Namespace
 *
