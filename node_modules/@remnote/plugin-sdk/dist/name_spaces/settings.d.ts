import { PluginDropdownSetting, PluginSettingBase, PluginStringSetting } from '../interfaces';
...
export declare class SettingsNamespace extends NamespaceBase {
     ...
     */
    registerBooleanSetting: (setting: PluginSettingBase<boolean>) => Promise<void>;
    /**
     ...
     */
    registerNumberSetting: (setting: PluginSettingBase<number>) => Promise<void>;
    /**
