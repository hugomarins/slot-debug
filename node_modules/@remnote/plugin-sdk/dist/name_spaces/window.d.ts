import { PageType_DUPE_1, PaneRemWindowTree, RemId, RemIdWindowTree } from '../interfaces';
import { InternalCallMethod, NamespaceBase } from './base';
import { RemObject } from './rem';
/**
 * # Window Namespace
 *
...
export declare class WindowNamespace extends NamespaceBase {
    ...
    openFloatingWidget: (fileName: string, position: {
        ...
        right?: number;
        bottom?: number;
    }, classContainer?: string, closeWhenClickOutside?: boolean) => Promise<string>;
    /**
     ...
     */
    openRem: (rem: RemObject) => Promise<void>;
    /**
     ...
     */
    isOnPage: (page: PageType_DUPE_1) => Promise<boolean>;
}
